...
import { X, Copy, Check, Send, Users, UserCheck, UserX, Crown, Gift, Hourglass, ChevronDown, MoreVertical, Settings, DollarSign } from 'lucide-react';
...
const REWARD_TIERS = [
  { friends: 1, taka: 50, videos: 2, btnClass: 'bg-gradient-to-r from-purple-500 to-indigo-500 shadow-purple-500/30' },
  { friends: 5, taka: 100, videos: 10, btnClass: 'bg-gradient-to-r from-pink-500 to-rose-500 shadow-pink-500/30' },
  { friends: 10, taka: 200, videos: 20, btnClass: 'bg-gradient-to-r from-blue-500 to-cyan-500 shadow-blue-500/30' },
  { friends: 20, taka: 400, videos: 40, btnClass: 'bg-gradient-to-r from-emerald-500 to-green-500 shadow-emerald-500/30' },
  { friends: 50, taka: 1000, videos: 100, btnClass: 'bg-gradient-to-r from-orange-500 to-amber-500 shadow-orange-500/30' },
  { friends: 100, taka: 2000, videos: 200, btnClass: 'bg-gradient-to-r from-purple-500 to-indigo-500 shadow-purple-500/30' },
  { friends: 300, taka: 5000, videos: 600, btnClass: 'bg-gradient-to-r from-pink-500 to-rose-500 shadow-pink-500/30' },
  { friends: 500, taka: 10000, videos: 1000, btnClass: 'bg-gradient-to-r from-blue-500 to-cyan-500 shadow-blue-500/30' },
  { friends: 1000, taka: 20000, videos: 2000, btnClass: 'bg-gradient-to-r from-emerald-500 to-green-500 shadow-emerald-500/30' },
  { friends: 2000, taka: 50000, videos: 5000, btnClass: 'bg-gradient-to-r from-orange-500 to-amber-500 shadow-orange-500/30' },
];
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-[#eef2ff] animate-in slide-in-from-bottom-2 sm:max-w-md sm:mx-auto sm:border-x border-slate-200 overflow-hidden">
      ...
      <div className="bg-gradient-to-b from-[#3b82f6] to-[#60a5fa] px-4 py-3 flex items-center justify-between text-white rounded-b-3xl shrink-0 shadow-md relative z-10">
        ...
        <div className="bg-white/20 backdrop-blur-md rounded-full px-4 py-1.5 flex items-center gap-2 border border-white/10 shadow-inner">
          ...
          <span className="text-xs font-black tracking-widest uppercase">33 Online</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 w-full">
        ...
        <div className="bg-gradient-to-br from-[#7e22ce] via-[#d946ef] to-[#f43f5e] rounded-[2.5rem] p-6 shadow-xl shadow-purple-500/20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-white/20 text-white text-[10px] font-black tracking-wider mb-5 backdrop-blur-sm shadow-sm border border-white/10 uppercase">
              <Crown size={14} className="text-yellow-300 drop-shadow-sm" /> PREMIUM REWARDS
            </div>

            <h2 className="text-3xl font-black text-white mb-3 drop-shadow-md tracking-tight">Invite Friends</h2>
            <p className="text-white/95 text-[13px] font-medium leading-relaxed px-2 drop-shadow-sm">
              For every successful referral you will get <span className="font-black text-yellow-300 text-[15px]">৳100.00</span> directly in pending balance! It moves to main balance once they start working.
            </p>
            ...
            <div className="bg-black/25 backdrop-blur-md border border-white/5 rounded-[1.5rem] p-4 mt-6 flex justify-between items-center shadow-inner">
              <div className="text-left">
                <div className="text-white/80 text-[10px] font-black tracking-wider mb-1 uppercase">Pending Referral Bonus</div>
                <div className="text-3xl font-black text-[#4ade80] drop-shadow-sm">৳0.00</div>
              </div>
            ...
            >
              ...
              <span className="text-[#78350f] font-black text-[17px]">Send to Inbox</span>
            </button>
            ...
            <div className="grid grid-cols-3 gap-3 mt-6">
              <div className="bg-white/10 backdrop-blur-sm border border-white/5 rounded-2xl p-3 flex flex-col items-center justify-center shadow-inner">
                ...
                <span className="text-xl font-black text-white">{referralsCount}</span>
                <span className="text-[10px] font-bold text-white/70 uppercase">Joined</span>
              </div>
              <div className="bg-white/10 backdrop-blur-sm border border-white/5 rounded-2xl p-3 flex flex-col items-center justify-center shadow-inner">
                <UserCheck className="text-emerald-300/90 mb-1" size={20} />
                <span className="text-xl font-black text-emerald-300">0</span>
                <span className="text-[10px] font-bold text-white/70 uppercase">Active</span>
              </div>
              <div className="bg-white/10 backdrop-blur-sm border border-white/5 rounded-2xl p-3 flex flex-col items-center justify-center shadow-inner">
                <UserX className="text-rose-300/90 mb-1" size={20} />
                <span className="text-xl font-black text-rose-300">0</span>
                <span className="text-[10px] font-bold text-white/70 uppercase">Inactive</span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-slate-100 mt-6 relative overflow-hidden">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <h3 className="text-xl font-black text-slate-800 text-center">Free Unlock Guide!</h3>
          </div>
          
          <div className="space-y-4">
            <div className="flex gap-3.5 items-start">
              <div className="w-7 h-7 rounded-full bg-indigo-500 text-white text-xs font-black flex items-center justify-center flex-shrink-0 mt-0.5 shadow-md shadow-indigo-500/20">1</div>
              <p className="text-slate-700 text-[13px] leading-relaxed font-medium">
                <span className="font-bold text-indigo-700">Invite Friends:</span> Get free video access per referral.
              </p>
            </div>
            <div className="flex gap-3.5 items-start">
              <div className="w-7 h-7 rounded-full bg-rose-500 text-white text-xs font-black flex items-center justify-center flex-shrink-0 mt-0.5 shadow-md shadow-rose-500/20">2</div>
              <p className="text-slate-700 text-[13px] leading-relaxed font-medium">
                <span className="font-bold text-rose-700">Milestones:</span> Watch ads to automatically get a <span className="font-bold text-rose-600">Gift Card!</span>
              </p>
            </div>
            <div className="flex gap-3.5 items-start">
              <div className="w-7 h-7 rounded-full bg-blue-500 text-white text-xs font-black flex items-center justify-center flex-shrink-0 mt-0.5 shadow-md shadow-blue-500/20">3</div>
              <p className="text-slate-700 text-[13px] leading-relaxed font-medium">
                <span className="font-bold text-blue-700">Daily Rewards:</span> Complete tasks to claim referral packages.
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 mb-6">
          <div className="flex items-center justify-between mb-5 px-1">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-black text-slate-800">24H Daily Rewards</h3>
            </div>
          ...
          <div className="bg-blue-50/70 border border-blue-100 rounded-[1.25rem] p-4 flex justify-center items-center gap-3 mb-6 shadow-sm">
            <span className="text-blue-900 font-bold text-[13px]">আজকের রেফার:</span>
          ...
          <div className="space-y-3.5">
            {REWARD_TIERS.map((tier, idx) => (
              <div key={idx} className="bg-white rounded-[1.5rem] p-4 flex items-center justify-between shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-slate-100 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <h4 className="font-black text-slate-800 text-[15px] mb-2">Invite {tier.friends} Friends</h4>
                  <div className="flex items-center gap-1.5 text-[10px] font-black">
                    <span className="bg-emerald-50 text-emerald-600 px-2 py-1 rounded-md border border-emerald-100 shadow-sm">+৳{tier.taka}.00</span>
                    <span className="bg-blue-50 text-blue-600 px-2 py-1 rounded-md border border-blue-100 shadow-sm">+{tier.videos} Free Videos</span>
                  </div>
                </div>
                <button 
