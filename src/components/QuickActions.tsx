    ...
    <div className="px-4 py-2" id="section-quick-actions">
      <div className="grid grid-cols-4 gap-2.5">
        ...
        <button
          ...
          className="flex flex-col items-center p-2.5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-indigo-300 hover:shadow transition-all group active:scale-95"
          id="btn-quick-tasks"
        >
        ...
        <button
          ...
          className="flex flex-col items-center p-2.5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-amber-300 hover:shadow transition-all group active:scale-95"
          id="btn-quick-videos"
        >
        ...
        <button
          ...
          className="flex flex-col items-center p-2.5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-blue-300 hover:shadow transition-all group active:scale-95"
          id="btn-quick-refer"
        >
        ...
        <button
          ...
          className="flex flex-col items-center p-2.5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-emerald-300 hover:shadow transition-all group active:scale-95"
